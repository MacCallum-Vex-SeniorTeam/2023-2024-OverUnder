...
class TankDrive {
    public:
        ...
        TankDrive(double wheelDiameter, double trackWidth, vex::distanceUnits units, double gear_ratio, vex::inertial *inertialSensor, vex::motor m, Args... m2) : motors(), slewControl(0.0001, 0.0001) {
            _AddMotor(m, m2...);
